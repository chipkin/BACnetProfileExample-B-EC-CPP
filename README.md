...
[v1.0.0](https://github.com/chipkin/BACnetProfileExample-B-EC-CPP/releases/tag/v1.0.0)
(`metrics-windows.json` / `metrics-linux.json`):

<!-- METRICS -->
| Platform | Binary | Size | Start-up to `ready` | Stack commit |
|---|---|---|---|---|
| Windows x64 (windows-2022) | `BACnetExampleBEC.exe` | 3,407,872 bytes (~3.2 MiB) | 75 ms | `abd4cee1` |
| Linux x64 (ubuntu-latest) | `BACnetExampleBEC` | 59,688 bytes (~58 KiB) | 12 ms | `abd4cee1` |

v1.0.0 was published from a prebuilt stack **STATIC** library rather than the
SOURCE-mode build documented above; the next release refreshes these numbers
